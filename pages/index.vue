<template>
  <div class=" w-full bg-white-200 font-sans leading-normal">
    <div class="section-container">
      <section class="flex flex-col h-screen w-full justify-center items-center pt-32 lg:pt-16 hero-wrapper event">
        <div class="container px-8 mx-auto pt-36 lg:px-4">
          <div class="flex flex-col w-full mb-12 text-left lg:text-center">
            <h1 class="mb-6 text-2xl font-semibold tracking-tighter text-white sm:text-6xl taters-knockout">
              Build 'em. Deploy 'em.
              <br class="">
              Stick 'em in a Stew.
            </h1>
            <h2 class="text-1xl tracking-tighter text-white sm:text-6xl taters-knockout">(Okay, maybe not that last
              part...)</h2>
            <p class="mx-auto text-base font-medium leading-relaxed text-white lg:w-2/3 taters-knockout">Good Tater Web
              Management is not just a Website Design Company, but a total Website Management Package. Our philosophy is
              simple - To be as good and simple as the humble 'tater.</p>
          </div>
        </div>
